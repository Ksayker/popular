 ...
 */
@InjectViewState
public class MostSharedPresenter extends ListPresenter {

    public MostSharedPresenter(ArticleInteractor interactor) {
        super(interactor);
    }

    @Override
    protected Single<List<Article>> loadArticles() {
        return (Single<List<Article>>)(Single<?>) interactor.getMostSharedArticles();
    }
}
